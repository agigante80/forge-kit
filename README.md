...
| `forge-kit-governance` | agent | `ticket-gate` | v22 | 5726 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
