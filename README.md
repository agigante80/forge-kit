...
**42 components across 7 plugin groups:** 14 agents, 4 commands, 16 skills, 4 hooks, 4 shell assets.
...
| `forge-kit-devops` | skill | `forge-host` | v15 | 1236 | Make governance components forge-host-aware (GitHub or self-hosted Forgejo/Gitea) instead of GitHub-only. |
...
| `forge-kit-governance` | agent | `ticket-gate` | v27 | 5715 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
