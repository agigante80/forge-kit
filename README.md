...
**46 components across 7 plugin groups:** 14 agents, 4 commands, 18 skills, 4 hooks, 6 shell assets.
...
| `forge-kit-security` | skill | `leak-guard` | v1 | 1214 | Stop the developer's own machine leaking into a repository that is about to be made public. |
