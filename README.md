...
**43 components across 7 plugin groups:** 14 agents, 4 commands, 17 skills, 4 hooks, 4 shell assets.

| Plugin group | Type | Component | Version | Words | What it does |
|---|---|---|---|---:|---|
| `forge-kit-adapt` | skill | `adapt` | v56 | 7316 | Analyse the current project and recommend the forge-kit components that fit it - subagents, skills, commands, and hooks… |
...
| `forge-kit-devops` | shell asset | `forge-lib` | v8 |  | forge-lib.sh: host-aware forge operations (GitHub \| Forgejo). |
...
| `forge-kit-governance` | agent | `ticket-gate` | v40 | 5486 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
...
| `forge-kit-governance` | skill | `ticket-gate-reference` | v7 | 1041 | Reference material the ticket-gate agent reads once per run: the review output template it composes, the specialist len… |
