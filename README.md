...
| `forge-kit-governance` | agent | `ticket-gate` | v37 | 5492 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
...
| `forge-kit-governance` | skill | `ticket-gate-reference` | v5 | 967 | Reference material the ticket-gate agent reads once per run: the review output template it composes, the specialist len… |
