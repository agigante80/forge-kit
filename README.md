...
**47 components across 7 plugin groups:** 14 agents, 4 commands, 18 skills, 4 hooks, 7 shell assets.
...
| `forge-kit-security` | shell asset | `check-private-leaks` | v4 |  | The PRIVATE half of the leak guard (forge-kit issue #99, split as #156): private project and |
| `forge-kit-security` | shell asset | `check-public-leaks` | v3 |  | The PUBLIC half of the leak guard (forge-kit issue #99, split as #155): the developer's machine |
