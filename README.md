...
**48 components across 8 plugin groups:** 14 agents, 4 commands, 19 skills, 4 hooks, 7 shell assets.
...
| `forge-kit-devops` | shell asset | `forge-lib` | v9 |  | forge-lib.sh: host-aware forge operations (GitHub \| Forgejo). |
