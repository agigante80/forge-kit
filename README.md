...
| `forge-kit-governance` | agent | `ticket-gate` | v33 | 5519 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
...
| `forge-kit-governance` | skill | `ticket-gate-reference` | v2 | 666 | Reference material the ticket-gate agent reads once per run: the review output template it composes, and the specialist… |
