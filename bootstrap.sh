...
echo ""
echo "ai-projectforge bootstrap"
echo "========================="
echo ""
...
echo "  2. Commit: git add .claude/ .github/ CLAUDE.md && git commit -m 'chore: add ai-projectforge governance'"
...
echo "  5. Keep ai-projectforge updated: git -C $SCAFFOLD_DIR pull"
echo ""
echo "Run /upgrade-audit at any time to see what's new in ai-projectforge."
