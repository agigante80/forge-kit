...
across `~/.claude/plugins`, path as tie-break, and the pick printed. The earlier form of this note
...
arbitrary. The canonical snippet is `ticket-gate.md` Step 3A; `phase.md` carries the same order as a
function.
