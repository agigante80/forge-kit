...
entry points that delegate to agents — recommend the command alongside the agent it drives.
...
| Pull-request workflow | `/pr-enhance` | review | generate PR description + checklist | — |
